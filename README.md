...
Take care about existing Bootstrap styles and JavaScript. It's *only* convient helper
...
Rails Bootstrap Helpers is licensed under [The MIT license](http://opensource.org/licenses/MIT)# Rails Bootstrap Helpers
